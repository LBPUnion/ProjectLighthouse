...
[XmlRoot("user")]
public class UserProfile : ILbpSerializable, INeedsPreparationForSerialization
{
    ...
    public static UserProfile CreateFromEntity(UserEntity entity, GameVersion targetGame)
    {
        UserProfile profile = CreateFromEntity(entity);
        profile.TargetGame = targetGame;
        return profile;
    }

    public static UserProfile CreateFromEntity(UserEntity entity) =>
        new()
        {
