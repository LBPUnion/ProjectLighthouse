...
public class LandingPage : BaseLayout
{
    ...
    public async Task<IActionResult> OnGet()
    {
        ...
        this.NewestLevels = await this.Database.Slots.Where(s => s.Type == "user").OrderByDescending(s => s.FirstUploaded).Take(maxShownLevels).Include(s => s.Creator).ToListAsync();
